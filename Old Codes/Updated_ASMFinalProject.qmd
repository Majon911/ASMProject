...
{r}
results_icm_advice <- simulate_ICM(advice, threshold_prob_advice)
results_icm_friend <- simulate_ICM(friend, threshold_prob_friend)
results_icm_work <- simulate_ICM(work, threshold_prob_work)
...
# All possible elements are in the 4th time spot.
